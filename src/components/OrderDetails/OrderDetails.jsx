...
function OrderDetails() {
  return ( 
    <div className={styles['order-detales']}>
      ...
      <p className={`text text_type_main-default ${styles['order-detales-text-color']}`}>Дождитесь готовности на орбитальной станции</p>
    </div>
   );
}
